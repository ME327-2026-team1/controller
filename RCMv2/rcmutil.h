...
#if RCM_HARDWARE_VERSION == RCM_ORIGINAL || RCM_HARDWARE_VERSION == RCM_4_V1 || RCM_HARDWARE_VERSION == ALFREDO_NOU2_NO_VOLTAGE_MONITOR || RCM_HARDWARE_VERSION == ALFREDO_NOU2_WITH_VOLTAGE_MONITOR || RCM_HARDWARE_VERSION == ALFREDO_NOU3
